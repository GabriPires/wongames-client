...
describe('<PaymentForm />', () => {
  ...
  it('should call createPayment when it render and render free if gets freeGames', async () => {
  ...
  it('should call createPayment when it render and render error if has any issue', async () => {
